                    ...
                    <div class="form-wrapp dark-transparent">
                        ...
                        <form class="row" method="post">
                            ...
                            <div class="col-md-6 mb30">
                                ...
                                <input name="emaile" class="form-control" placeholder="votre E-mail" type="email"/>
                            </div>
                            <div class="col-md-6 mb30">
                                <label>
                                   Mot de passe :
                                </label>
                                <input name="passe" class="form-control" placeholder="Mot de passe" type="password"/>
                            </div>
                            ...
                            <div class="col-md-12">
                                 <h5 style="padding-top:10px;text-decoration:underline #E6610A"> <i class="fa fa-user"  style="color:#E6610A"> </i> <a href="inscriptione.php">Créer mon compte </a> </h5>
                            </div> 
...
if(isset($_POST['btn'])){
    ...
    $emaile= mysqli_real_escape_string($conn, $_POST['emaile']);
    ...
    $rech=mysqli_query($conn,"select * from employeur where emaile='$emaile' and passe='$passe'");
    ...
    if(mysqli_num_rows($rech)<=0){
        ...
        $_SESSION["ide"]=$data["ide"];
        $_SESSION["nome"]=$data["nome"];
      
      
        //maj last visit
        $ide=$_SESSION["ide"];
        $enlign=mysqli_query($conn,"update employeur set last_visit='$dt' where ide=$ide");
